# -*- coding: utf-8 -*-
"""
Created on Sat Feb 17 18:25:40 2018

@author: bumurzokov
"""
from PIL import Image,ImageDraw

my_data=[['slashdot','USA','yes',25,'None'],
         ['google','France','yes',13,'Premium'],
         ['digg','USA','yes',14,'Basic'],
         ['kiwitobes','France','yes',24,'Basic'],
         ['google','UK','no',15,'Premium'],
         ['(direct)','New Zealand','no',12,'None'],
         ['(direct)','UK','no',21,'Basic'],
         ['google','USA','no',24,'Premium'],
         ['slashdot','France','yes',19,'None'],
         ['digg','USA','no',16,'None'],
         ['google','UK','no',43,'None'],
         ['kiwitobes','UK','no',19,'None'],
         ['digg','New Zealand','yes',12,'Basic'],
         ['slashdot','UK','no',21,'None'],
         ['google','UK','yes',21,'Basic'],
         ['kiwitobes','France','yes',13,'Basic']]
...
class decisionnode:
    ...
    def __init__(self,col=-1,value=None,results=None,tb=None,fb=None):
        ...
        self.tb=tb
        self.fb=fb
#Function divideset below which divides the rows into two sets based on the data in a specific column
def divideset(rows,column,value, greaterEqual = 0):
    # If a row is in the first group then true or in the second group then false
    split_function=None
...
# Function buildtree, a recursive function that builds the tree by choosing the best dividing criteria for
# the current set.
...
def drawtree(tree,png='tree_represantion.png'):
    w=getwidth(tree)*100
